...
export function LocalZoomToggle() {
  ...
  return (
    <label
      className="inline-flex h-8 cursor-pointer select-none items-center gap-2 rounded-lg border border-border bg-card px-2 text-xs text-muted-foreground hover:bg-muted"
